...
CREATE INDEX idx_booking_start ON booking(start_time);
CREATE INDEX idx_booking_end ON booking(end_time);
...
-- Demo rooms
INSERT INTO room (room_name, capacity, status, description) VALUES 
...
-- Demo devices
INSERT INTO device (device_name, room_id, status, description) VALUES 
